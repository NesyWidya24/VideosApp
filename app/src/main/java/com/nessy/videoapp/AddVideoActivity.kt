...
class AddVideoActivity : AppCompatActivity() {
    ...
    private fun uploadVideoFirebase() {
        ...
        //storage ref
        val storaReference = FirebaseStorage.getInstance().getReference(filePathAndName)
        //upload video using uri of video to storage
        storaReference.putFile(videoUri!!)
            .addOnSuccessListener { taskSnapshot ->
                ...
                if (uriTask.isSuccessful){
                    ...
                    //now can add video details to firebase db
    ...
    private fun setVideoToVideoView() {
        ...
        videoView.setOnPreparedListener {
            //when video is ready, default don't play automatically
            videoView.pause()
        }
    }
